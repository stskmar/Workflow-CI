...
model = mlflow.pyfunc.load_model("models:/workflow-ci-mlflow/Production")
...
PREDICTION_COUNT = Counter(
    "prediction_total", "Total predictions", ["label"]
)

ERROR_COUNT = Counter(
    "inference_errors_total", "Total inference errors"
)
